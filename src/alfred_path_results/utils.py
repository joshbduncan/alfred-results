...
utils
-----
General-purpose utilities for alfred-path-results.
...
# Custom UUID v5 namespace for alfred-path-results filesystem path identifiers.
# Derived via uuid5(NAMESPACE_DNS, "alfred-path-results") so it is stable,
# unique to this package, and follows the standard convention for custom
# namespaces (RFC 4122 Appendix C).
_PATH_UUID_NAMESPACE: UUID = UUID("2e88f2e8-148d-5509-a1d0-623c34c3d038")
